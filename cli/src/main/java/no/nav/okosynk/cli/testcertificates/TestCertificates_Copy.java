...
public final class TestCertificates_Copy {
    ...
    public static void setupTemporaryKeyStore(
        final String keyStoreResourceName,
        final String password) {

        InputStream keyStore = TestCertificates_Copy.class.getClassLoader().getResourceAsStream(keyStoreResourceName);
    ...
    public static void setupTemporaryKeyStore(
        ...
        (new KeyStore_Copy(FileUtils_Copy.putInTempFile(keystore).getAbsolutePath(), password)).setOn(System.getProperties());
    }

    public static void setupTemporaryTrustStore(
        final String trustStoreResourceName,
        final String password) {

        InputStream trustStore = TestCertificates_Copy.class.getClassLoader().getResourceAsStream(trustStoreResourceName);
    ...
    public static void setupTemporaryTrustStore(
        ...
        (new TrustStore_Copy(FileUtils_Copy.putInTempFile(trustStore).getAbsolutePath(), password)).setOn(System.getProperties());
    }
}
