...
public class PostOppgaveResponseJson extends AbstractOppgaveJson {

    private Collection<IdentJson> identer;

    public PostOppgaveResponseJson() {
        super();
    }
    ...
    public boolean equals(final Object other) {
        ...
        final PostOppgaveResponseJson otherPostOppgaveResponseJson = (PostOppgaveResponseJson) other;
        ...
        final Object[] otherIdentArray =
                otherPostOppgaveResponseJson.getIdenter() == null
                        ?
                        new IdentJson[0]
                        :
                        otherPostOppgaveResponseJson.getIdenter().stream().sorted(
                                        Comparator.comparing(a -> a.getGruppe().navn())
                                )
                                .toArray();
