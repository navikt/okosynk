 ...
 */
public class UrMeldingLinjeFtpReaderUsingRealFtpTest
    ...
    protected Function<String, IMeldingLinjeFileReader> getCreator() {
        ...
        return (
            ...
            new MeldingLinjeFtpReader(getOkosynkConfiguration(), Constants.BATCH_TYPE.UR, fullyQualifiedInputFileName);
    }
}
