...
import no.nav.okosynk.domain.os.OsMeldingBatchInputRecordBuilder;
import no.nav.okosynk.domain.os.OsMeldingBuilder;
...
class UrMeldingTest extends AbstractMeldingTest {
    ...
    void equalsAnnenGjelderIdGirFalse() {
        ...
        assertFalse(melding.equals(melding2));
    ...
    void equalsLikMeldingGirTrue() {
        ...
        assertTrue(melding.equals(melding2));
