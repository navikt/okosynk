...
class OsMapperTest {
    ...
    private static final String OS_MELDING_SOM_IKKE_GJELDER_TSS_OG_HAR_MAPPING = "07063000250009543471 2008-10-102008-10-10NEG K231B2962008-11-012008-11-30000000008820å 4151         GS      07063000250            ";
    private static final String ANNEN_OS_MELDING_SOM_IKKE_GJELDER_TSS_OG_HAR_MAPPING = "06128074978009543471 2008-10-102008-10-10NEG K231B2962008-11-012008-11-30000000008820å 4151         GS      06128074978            ";
    ...
    private static final String OS_MELDING_EFOG =
        "01017840025333374207 2019-02-132019-02-14AVVMK231B26E2018-10-012019-02-28000000090040æ 8020         EFOG    01017840025            ";
    ...
    @BeforeEach
    void setUp() {
        osMapper = new OsMapper(new AktoerRestClient(new FakeOkosynkConfiguration(), Constants.BATCH_TYPE.OS));
