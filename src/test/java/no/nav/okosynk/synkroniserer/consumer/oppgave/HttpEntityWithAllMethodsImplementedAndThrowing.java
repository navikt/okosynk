...
public class HttpEntityWithAllMethodsImplementedAndThrowing implements HttpEntity {
  ...
  @Override public void writeTo(OutputStream outputStream) {throw new UnsupportedOperationException("NYI");}
  @Override public boolean isStreaming() {throw new UnsupportedOperationException("NYI");}
  @Override public void consumeContent() {throw new UnsupportedOperationException("NYI");}
}
