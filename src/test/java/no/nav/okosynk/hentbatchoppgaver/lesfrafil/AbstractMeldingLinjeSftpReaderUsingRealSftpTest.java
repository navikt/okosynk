...
import no.nav.okosynk.hentbatchoppgaver.lesfrafil.exceptions.AbstractOkosynkIoException;
...
import no.nav.okosynk.metrics.AbstractTestFtpServer;
import no.nav.okosynk.metrics.TestFtpServer;
import no.nav.okosynk.metrics.TestSftpServer;
