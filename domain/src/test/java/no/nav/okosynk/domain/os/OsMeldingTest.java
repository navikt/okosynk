...
import no.nav.okosynk.domain.AbstractMeldingTest;
import no.nav.okosynk.domain.ur.UrMelding;
import no.nav.okosynk.domain.ur.UrMeldingBatchInputRecordBuilder;
...
class OsMeldingTest extends AbstractMeldingTest {
    ...
    void equalsOgHashPaSammeObjekt() {
        ...
        assertTrue(melding.equals(melding));
    ...
    void equalsNullObjektGirFalse() {
        ...
        assertFalse(melding.equals(null));
    }
    ...
    void equalsAnnetObjektGirFalse() {
        ...
        assertFalse(melding.equals(annetObjekt));
    }
    ...
    void equalsAnnenGjelderIdTypeGirFalse() {
        ...
        assertFalse(personMelding.equals(organisasjonMelding));
    ...
    void equalsLikMeldingGirTrue() {
        ...
        assertTrue(personMelding.equals(organisasjonMelding));
    ...
    public void test_that_all_equal_meldinger_hash_to_the_same_value() {
            ...
            OsMeldingBuilder
                ...
                .withMeldingBatchInputRecordBuilder(
                    OsMeldingBatchInputRecordBuilder
                        ...
                        .withForsteFomIPeriode(AbstractMeldingTest.randomLocalDate(random))
                        .withSisteTomIPeriode(AbstractMeldingTest.randomLocalDate(random))
                        .withFlaggFeilkonto(AbstractMeldingTest.randomAlphanumeric(totalRecordLength, random))
                        .withUtbetalesTilId(AbstractMeldingTest.randomNumeric(11, random))
                        .withEtteroppgjor(AbstractMeldingTest.randomAlphanumeric(totalRecordLength, random))
                )
                .build();
