...
class OsOppgaveOppretterTest {
    ...
    void applyReturnererOppgaveMedRiktigeVerdier() {
        ...
        assertAll(
                () -> assertEquals("10108000398", oppgave.brukerId),
                () -> assertEquals("PERSON", oppgave.brukertypeKode),
                () -> assertEquals("OKO_OS", oppgave.oppgavetypeKode),
                () -> assertEquals("OKO", oppgave.fagomradeKode),
                () -> assertEquals("INNT", oppgave.underkategoriKode),
                () -> assertEquals("LAV_OKO", oppgave.prioritetKode),
